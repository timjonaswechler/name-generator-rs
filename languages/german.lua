...
profile.phonemes = {
    ...
    {ipa = "[b]", phoneme_type = "Consonant", grapheme = "b", frequency = 0.6},
    {ipa = "[t]", phoneme_type = "Consonant", grapheme = "t", frequency = 0.9},
    {ipa = "[d]", phoneme_type = "Consonant", grapheme = "d", frequency = 0.7},
    {ipa = "[k]", phoneme_type = "Consonant", grapheme = "k", frequency = 0.8},
    {ipa = "[g]", phoneme_type = "Consonant", grapheme = "g", frequency = 0.6},
    {ipa = "[f]", phoneme_type = "Consonant", grapheme = "f", frequency = 0.7},
    {ipa = "[v]", phoneme_type = "Consonant", grapheme = "w", frequency = 0.5},
    {ipa = "[s]", phoneme_type = "Consonant", grapheme = "s", frequency = 0.9},
    {ipa = "[z]", phoneme_type = "Consonant", grapheme = "s", frequency = 0.4},
    {ipa = "[ʃ]", phoneme_type = "Consonant", grapheme = "sch", frequency = 0.6},
    {ipa = "[ç]", phoneme_type = "Consonant", grapheme = "ch", frequency = 0.5},
    {ipa = "[h]", phoneme_type = "Consonant", grapheme = "h", frequency = 0.7},
    {ipa = "[m]", phoneme_type = "Consonant", grapheme = "m", frequency = 0.8},
    {ipa = "[n]", phoneme_type = "Consonant", grapheme = "n", frequency = 0.9},
    {ipa = "[l]", phoneme_type = "Consonant", grapheme = "l", frequency = 0.8},
    {ipa = "[ʁ]", phoneme_type = "Consonant", grapheme = "r", frequency = 0.7},
    {ipa = "[j]", phoneme_type = "Consonant", grapheme = "j", frequency = 0.5},
